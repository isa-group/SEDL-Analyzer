...
public class ComputeStats extends AbstractAnalysisOperation<StatisticalAnalysisConfiguration, List<StatisticalAnalysisOperation>> {
    ...
    public List<String> getCandidateDatasetFiles(ControlledExperiment element) {
    ...
    public List<StatisticalAnalysisOperation> apply(ControlledExperiment element) {
    ...
    public List<StatisticalAnalysisOperation> applyCSV(ControlledExperiment experiment, String csvContent) {
        ...
        List<ValidationError<ControlledExperiment>> validation = dv.validateDataset();
    ...
    public DataSet parseCsvContent(String csvContent) {
        ...
        try {
            ...
            dataset = loader.load(new StringInputStream(csvContent), "csv");
    ...
    public List<StatisticalAnalysisOperation> generateStatisticalAnalysisOperations(ControlledExperiment experiment) {
        ...
        for (AnalysisSpecificationGroup anSpec : analyses) {
            ...
            if (anSpec instanceof StatisticalAnalysisSpec) {
                for (Statistic statistic : ((StatisticalAnalysisSpec) anSpec).getExpandedStatistics(experiment)) {
    ...
    public List<StatisticalAnalysisOperation> calculateStats(List<StatisticalAnalysisOperation> operations, String csvContent, ControlledExperiment experiment) {
    ...
    class StatisticalAnalysisConfiguration {
        ...
        public StatisticalAnalysisConfiguration(ControlledExperiment experiment, String datasetURI) {
         ...
         */
        public ControlledExperiment getExperiment() {
            return experiment;
        }
         ...
         */
        public void setExperiment(ControlledExperiment experiment) {
            this.experiment = experiment;
        }
